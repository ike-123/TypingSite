        ...
        <>
            {
                !props.isKeyPackage ?
                    ...
                    <div className='flex flex-col bg-indigo-500 w-70 h-90 rounded-2xl' onClick={() => { handleClick(props.item) }}>
                    ...
                    <div className='flex flex-col bg-purple-500 w-70 h-90 rounded-2xl' onClick={() => { handleClick(props.item) }}>
                        {/* <Button onClick={handleCheckout}>Buy Item</Button> */}
